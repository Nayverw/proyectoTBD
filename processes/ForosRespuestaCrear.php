...
$query = $conn->prepare("INSERT INTO RESPUESTA_PREGUNTA (descripcion, fecha, id_pregunta_foro, id_rol_usuario) VALUES (?, ?, ?, ?)");
$query->bind_param("ssii", $descripcion, $fecha, $idPregunta, $idRolUsuario);
