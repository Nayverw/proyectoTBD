            ...
            data.forEach(p => {
                ...
                preguntaDiv.innerHTML = `
                    <div style="font-weight:bold; text-align:left;">
                        ${p.rol}. ${p.usuario}: ${p.descripcion}
                        <small style="color:gray;">(${p.fecha})</small>
                    </div>

                    <div id="respuestas_${p.id_pregunta_foro}" 
                         style="margin-left:30px; margin-top:5px; text-align:left;">
    ...
    function cargarRespuestas(idPregunta) {
        ...
        .then(data => {
            ...
            data.forEach(r => {
                ...
                rDiv.style = "margin-top:3px; padding-left:10px; text-align:left;";

                rDiv.innerHTML = `
                    ${r.rol}. ${r.usuario}: ${r.descripcion}
