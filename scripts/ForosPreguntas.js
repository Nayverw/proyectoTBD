// C:\xampp\htdocs\proyectoTBD\scripts\ForosPreguntas.js

export function cargarPreguntasForo({ idRol, idForo, origen }) {
    console.log("ForosPreguntas.js cargado correctamente.");
    console.log("ID Rol:", idRol, "ID Foro:", idForo, "Origen:", origen);
    ...
    contenedor.innerHTML = `
        <div style="width: 90%; margin: 20px auto;">
            ...
            <!-- FILA: BOTÓN VOLVER + IMAGEN + INPUT + BOTÓN PUBLICAR -->
            <div style="
                display:flex;
                align-items:center;
            ...
            ">
                ...
                <input type="text" id="inputNuevaPregunta" placeholder="Escribe tu pregunta..." style="
                    flex:1;
                    padding:8px; 
                    border-radius:5px; 
            ...
            <!-- DIV DINÁMICO PARA PREGUNTAS Y RESPUESTAS -->
